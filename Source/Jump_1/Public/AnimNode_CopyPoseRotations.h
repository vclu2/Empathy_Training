...
USTRUCT()
struct FJump_1_BoneSourceToTargetMapping
{
	GENERATED_BODY()
...
struct FJump_1_BoneSourceSettings
{
...
struct JUMP_1_API FAnimNode_CopyPoseRotations : public FAnimNode_Base
{
	...
	TArray<FJump_1_BoneSourceToTargetMapping> BoneMapping;
...
private:
	...
	TMap<int32, FJump_1_BoneSourceSettings> BoneMapToSourceSettings;
